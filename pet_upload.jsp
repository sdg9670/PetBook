...
try{
	...
	while(files.hasMoreElements()){
		...
		if(file != null)
		{
			...
			petdao.updatePicture(Integer.parseInt(upload.getParameter("petid")), pdto.getId());
		}
%>
<jsp:forward page="pet_edit.jsp">
	<jsp:param value="<%=upload.getParameter(\"petid\")%>" name="petid"/>
</jsp:forward>
<%
    }
	result += "----------------------<br>";
